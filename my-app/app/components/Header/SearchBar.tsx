...
const SearchBar = () => {
  ...
  return (
    <div className="search-container relative w-full z-[100] max-w-2xl mx-auto">
      {/* Search Input */}
      ...
      {/* Loading state */}
      {loading && searching && searchQuery.trim().length > 0 && (
      ...
      {/* Mobile search overlay for better mobile experience */}
      {searching && (
        <div className="md:hidden fixed inset-0 bg-black bg-opacity-50 z-40" onClick={() => setSearching(false)} />
      )}
    </div>
  );
};
