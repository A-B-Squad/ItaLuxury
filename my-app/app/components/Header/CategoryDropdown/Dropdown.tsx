...
const Dropdown = ({ setShowDropdown, showCategoryDropdown }: any) => {
  ...
  return (
    <div
      ...
      className={` md:border md:pl-5 hidden  md:flex md:py-5  bg-[#f8f9fd] md:gap-2 absolute md:h-fit md:w-3/4 md:shadow-md md:rounded-md h-fit   transition-all duration-700 ${
        showCategoryDropdown
          ? " mt-0 opacity-100 visible z-20"
