...
const NoProductYet = () => {
  return (
    <div className="grid items-center w-full grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-3">
      {[...Array(8)].map((_, index) => (
        <div key={index} className="bg-white border rounded-md overflow-hidden shadow-sm">
          <div className="h-56 w-full bg-gray-50 animate-pulse flex items-center justify-center">
            <Image
